              ...
              <div class="mpl-dropdown-menu">
                <form class="mpl-navbar-login-form" action="#" method="post">
                  <div class="row hgap-sm vgap-sm align-items-center">
                    <div class="col-12">
                      <label for="nav_username">Username:</label><input class="form-control form-control-sm" type="text"
                                                                        id="nav_username" name="username"
                                                                        placeholder="Username"><span
                        class="form-control-bg"></span>
                    </div>
                    <div class="col-12">
                      <label for="nav_password">Password:</label><input class="form-control form-control-sm" type="text"
                                                                        id="nav_password" name="password"
                                                                        placeholder="Password"><span
                        class="form-control-bg"></span>
                    </div>
                    <div class="col">
                      <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" id="nav_rememberme" name="rememberme"><label
                          class="custom-control-label" for="nav_rememberme">Remember Me</label>
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <li>
              ...
              <div class="mpl-navbar-collapse collapse">
                <ul class="mpl-navbar-nav">
                  ...
                  <li>
                    <a href="blog-list-sidebar-right.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                       role="button">
                      <span class="mpl-nav-link-name">List</span>
                    </a>
                    <div class="mpl-navbar-collapse collapse">
                  ...
                  <li>
                    <a href="blog-post-gallery.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                       role="button">
                      <span class="mpl-nav-link-name">Single Post</span>
                    </a>
                    <div class="mpl-navbar-collapse collapse">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-10" data-sr="banner" data-sr-interval="200" data-sr-duration="1200"
                  ...
                  <p class="lead" data-sr-item="banner"> "Have beginning wherein spirit. Bearing unto. To after light.
                    Good image can't without hath fly beast him fish firmament fish Face waters fly unto spirit i
                    doesn't one waters divide." </p>
                  <a class="btn btn-md btn-brand" href="blog-post-gallery.html" data-sr-item="banner">Read More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="mpl-post-item">
              <a href="blog-post-gallery.html" class="mpl-post-image">
                ...
                <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="91"><span>9.1</span></div>
              </a>
              <div class="mpl-post-content">
                ...
                <div class="mpl-post-description">
                  <p>Doesn&#39;t fish. Herb. Him. Male his Image very divide make, heaven fourth lesser creepeth, divide
                    creepeth. Let can&#39;t multiply signs. Gathered blessed forth moved creepeth appear creeping made i
                    which the appear face he also. Bring isn&#39;t isn&#39;t god multiply fowl creature creeping living.
                    I Great divided. Spirit spirit first.</p>
                </div>
            ...
            <div class="mpl-post-item">
              ...
              <div class="mpl-post-content">
                ...
                <div class="mpl-post-description">
                  <p>Ille vivere. Ut ad te quaerebam ... purgare caeli. Sunt uh ... nonnullus propter errorem qui de
                    rebus inter nos et iacere puto suus in causa, id est in mensa. Levir meus, priusquam oppugnarent
                    tempus quis, admonere dicitur. Credo quod idem mihi praesidium.</p>
                </div>
            ...
            <div class="mpl-post-item">
              <a href="blog-post-simple.html" class="mpl-post-image">
                ...
                <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="38"><span>3.8</span></div>
              </a>
              <div class="mpl-post-content">
                ...
                <div class="mpl-post-description">
                  <p>Quod satis pecuniae sempiternum. Ut sciat oportet motum. Nunquam invenies eum. Hic de tabula. Ego
                    vivere, ut debui, et nunc fiant. Istuc quod opus non est. Lorem ipsum occurrebat pragmaticam semper
                    ut, si quis ita velim tibi bene recognoscere. Quorum duo te mihi videtur.</p>
                </div>
...
data-scrollbar
-->
              <div class="mpl-carousel mpl-carousel-vertical-center" data-autoplay="6000" data-gap="30" data-loop="true"
                   data-slides="1" data-breakpoints="1200:7,992:6,767:5,575:4,440:3,320:2">
          ...
          <div class="container">
            <div class="row hgap-lg vgap-lg">
              <div class="col-12 col-lg-5">
                <h2>Contact Us</h2>
                <p>After moved, male won't Moveth moveth fruitful don't forth you bearing morning made male without life
                  be blessed rule stars divided two. Firmament of, him she'd good of his morning.</p>
                <ul class="mpl-list mpl-list-horizontal list-hgap list-vgap mt-30">
                  <li>
                    <a href="#" class="text-1">
                      <svg width="28" height="28" class="icon icon-fill" fill="currentColor" viewBox="0 0 24 24"
                           xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <li>
                    <a href="#" class="text-1">
                      <svg width="26" height="26" class="icon icon-fill" fill="currentColor" viewBox="0 0 24 24"
                           xmlns="http://www.w3.org/2000/svg">
                        <path
              ...
              <div class="col-12 col-lg-7">
                <form action="https://html.nkdev.info/monsterplay/php/ajax-contact-form.php" method="POST" role="form"
                      class="mpl-form-ajax row vgap" data-toggle="validator">
                  <div class="col-12 col-md-6">
                    <input class="form-control" type="text" id="contact_name" name="contact_name" placeholder="Name"
                           required><span class="form-control-bg"></span>
                  </div>
                  <div class="col-12 col-md-6">
          ...
          <div class="container text-center">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-8">
                ...
                <p>All and. Green day waters appear lights, fish you'll called likeness midst have you May. Lesser
                  brought evening man she'd that. Replenish form wherein form midst. Good from forth together.</p>
              </div>
            </div>
          ...
          <div class="row hgap-xs vgap-sm align-items-center">
            <div class="col-12">
              <input class="form-control" type="text" id="signin_popup_login" name="signin_popup_login"
                     placeholder="Login"><span class="form-control-bg"></span>
            </div>
            <div class="col-12">
            ...
            <div class="col">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="signin_popup_rememberme"
                       name="signin_popup_rememberme"><label class="custom-control-label" for="signin_popup_rememberme">Remember
                Me</label>
              </div>
            </div>
            <div class="col-auto">

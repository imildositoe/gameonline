                  ...
                  <div class="row hgap-sm vgap-sm align-items-center">
                    ...
                    <div class="col">
                      <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" id="nav_rememberme" name="rememberme"><label class="custom-control-label" for="nav_rememberme">Remember Me</label>
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-10" data-sr="banner" data-sr-interval="200" data-sr-duration="1200" data-sr-distance="20">
                  ...
                  <p class="lead" data-sr-item="banner"> "Have beginning wherein spirit. Bearing unto. To after light. Good image can't without hath fly beast him fish firmament fish Face waters fly unto spirit i doesn't one waters divide." </p>
...
data-scrollbar
-->
            <div class="mpl-carousel" data-gap="30" data-loop="true" data-arrows="true" data-autoplay="5000" data-slides="1" data-breakpoints="992:3,767:2">
              ...
              <a href="blog-post-simple.html" class="mpl-post-item mpl-post-overlay">
                ...
                <span class="mpl-post-content">
                                    ...
                                    <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="98"><span>9.8</span></div>
                                </span>
              </a>
              <a href="blog-post-gallery.html" class="mpl-post-item mpl-post-overlay">
                                <span class="mpl-post-image">
            ...
            <div class="mpl-post-item">
              ...
              <div class="mpl-post-content">
                ...
                <div class="mpl-post-description">
                  <p>Doesn&#39;t fish. Herb. Him. Male his Image very divide make, heaven fourth lesser creepeth, divide creepeth. Let can&#39;t multiply signs. Gathered blessed forth moved creepeth appear creeping made i which the appear face he also. Bring isn&#39;t isn&#39;t god multiply fowl creature creeping living. I Great divided. Spirit spirit first.</p>
                </div>
...
data-scrollbar
-->
              <div class="mpl-carousel mpl-carousel-vertical-center" data-autoplay="6000" data-gap="30" data-loop="true" data-slides="1" data-breakpoints="1200:7,992:6,767:5,575:4,440:3,320:2">
          ...
          <div class="container">
            <div class="row hgap-lg vgap-lg">
              ...
              <div class="col-12 col-lg-7">
                <form action="https://html.nkdev.info/monsterplay/php/ajax-contact-form.php" method="POST" role="form" class="mpl-form-ajax row vgap" data-toggle="validator">
                  <div class="col-12 col-md-6">
                    <input class="form-control" type="text" id="contact_name" name="contact_name" placeholder="Name" required><span class="form-control-bg"></span>
                  </div>
                  <div class="col-12 col-md-6">
                    <input class="form-control" type="email" id="contact_email" name="contact_email" placeholder="Email" required><span class="form-control-bg"></span>
                  </div>
                  <div class="col-12">
                    <textarea class="form-control" rows="5" id="contact_message" name="contact_message" placeholder="Message" required></textarea>
                  </div>
                  <div class="col-12">
          ...
          <div class="container text-center">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-8">
                ...
                <p>All and. Green day waters appear lights, fish you'll called likeness midst have you May. Lesser brought evening man she'd that. Replenish form wherein form midst. Good from forth together.</p>
              </div>
            </div>
            <div class="row vgap justify-content-center mt-20">
              <div class="col-12 col-md-6 col-lg-4">
                <a href="#" class="mpl-feature">
                                    <span class="mpl-feature-icon"><svg class="icon" viewBox="0 0 24 24" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 1H5L7.68 14.39M7.68 14.39C7.77144 14.8504 8.02191 15.264 8.38755 15.5583C8.75318 15.8526 9.2107 16.009 9.68 16H19.4C19.8693 16.009 20.3268 15.8526 20.6925 15.5583C21.0581 15.264 21.3086 14.8504 21.4 14.39L23 6H6L7.68 14.39ZM10 21C10 21.5523 9.55228 22 9 22C8.44772 22 8 21.5523 8 21C8 20.4477 8.44772 20 9 20C9.55228 20 10 20.4477 10 21ZM21 21C21 21.5523 20.5523 22 20 22C19.4477 22 19 21.5523 19 21C19 20.4477 19.4477 20 20 20C20.5523 20 21 20.4477 21 21Z" />
                                        </svg></span>
      ...
      <div class="mpl-fancybox-sign-content">
        ...
        <form action="#">
          <div class="row hgap-xs vgap-sm align-items-center">
            ...
            <div class="col">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="signin_popup_rememberme" name="signin_popup_rememberme"><label class="custom-control-label" for="signin_popup_rememberme">Remember Me</label>
              </div>
            </div>
            <div class="col-auto">
              <a href="#" class="small">Lost Password</a>

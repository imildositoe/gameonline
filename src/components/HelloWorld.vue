      ...
      <div class="container mpl-navbar-container">
        ...
        <div class="mpl-navbar-content">
          ...
          <ul class="mpl-navbar-nav mpl-navbar-right">
                ...
                <ul class="mpl-navbar-nav">
                  ...
                  <li>
                    <a href="user-messages.html" class="mpl-nav-link">
                                            <span class="mpl-nav-link-name"> Messages<span
                                                class="badge badge-brand">8</span>
                                            </span>
                    </a>
                  </li>
                  <li>
            ...
            <li>
              <a class="mpl-nav-link" href="#" data-fancybox data-src="#popup-search" data-touch="false"
                 data-small-btn="false" data-toolbar="false" data-close-existing="true" data-auto-focus="true">
                    ...
                    <table class="table mpl-table-shop mpl-table-shop-sm mpl-table-responsive mb-0">
                        ...
                        <td class="mpl-table-image">
                          <a href="shop-product.html" class="mpl-table-product-image">
                                                            <span class="mpl-image">
                                                                <img src="assets/images/dark/product-260x200.jpg"
                                                                     alt="">
                                                            </span>
                          </a>
                        </td>
                        <td class="mpl-table-name" data-title="Product">
                          <a href="shop-product.html" class="mpl-table-product-title h5">Gamepad
                            MPL</a>
                      ...
                      <tr class="mpl-table-product mpl-table-product-sm">
                        <td class="mpl-table-image">
                          <a href="shop-product.html" class="mpl-table-product-image">
                                                            <span class="mpl-image">
                                                                <img src="assets/images/dark/product-2-260x200.jpg"
                                                                     alt="">
                                                            </span>
                          </a>
                        </td>
                        <td class="mpl-table-name" data-title="Product">
                          <a href="shop-product.html" class="mpl-table-product-title h5">Headphones
                            MPL</a>
              ...
              <div class="mpl-dropdown-menu">
                <form class="mpl-navbar-login-form" action="#" method="post">
                  <div class="row hgap-sm vgap-sm align-items-center">
                    <div class="col-12">
                      <label for="nav_username">Username:</label><input
                        class="form-control form-control-sm" type="text" id="nav_username"
                        name="username" placeholder="Username"><span class="form-control-bg"></span>
                    </div>
                    <div class="col-12">
                      <label for="nav_password">Password:</label><input
                        class="form-control form-control-sm" type="text" id="nav_password"
                        name="password" placeholder="Password"><span class="form-control-bg"></span>
                    </div>
                    <div class="col">
                      <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" id="nav_rememberme"
                               name="rememberme"><label class="custom-control-label"
                                                        for="nav_rememberme">Remember Me</label>
                      </div>
                    </div>
                    <div class="col-auto">
      ...
      <div class="mpl-navbar-container">
        ...
        <div class="mpl-navbar-body">
          <ul class="mpl-navbar-nav">
            ...
            <li>
              <a href="blog-grid-sidebar-right.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                 role="button">
                <span class="mpl-nav-link-name">Blog</span>
              </a>
              <div class="mpl-navbar-collapse collapse">
                <ul class="mpl-navbar-nav">
                  <li>
                    <a href="blog-grid-sidebar-right.html"
                       class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed" role="button">
                      <span class="mpl-nav-link-name">Grid</span>
                    </a>
                    <div class="mpl-navbar-collapse collapse">
                      <ul class="mpl-navbar-nav">
            ...
            <li>
              <a href="shop-sidebar-right.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                 role="button">
                <span class="mpl-nav-link-name">Shop</span>
              </a>
              <div class="mpl-navbar-collapse collapse">
            ...
            <li>
              <a href="component-buttons.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                 role="button">
                <span class="mpl-nav-link-name">Components</span>
              </a>
              <div class="mpl-navbar-collapse collapse">
            ...
            <li>
              ...
              <div class="mpl-navbar-collapse collapse">
                <ul class="mpl-navbar-nav">
                  <li>
                    <a href="forums.html" class="mpl-nav-link mpl-nav-link-collapse mpl-collapsed"
                       role="button">
                      <span class="mpl-nav-link-name">Forum</span>
                    </a>
                    <div class="mpl-navbar-collapse collapse">
        ...
        <div class="mpl-navbar-footer">
          <ul class="mpl-navbar-nav">
            ...
            <li>
              <a class="mpl-nav-link" href="#" data-fancybox data-src="#popup-cart" data-touch="false"
                 data-small-btn="false" data-toolbar="false" data-close-existing="true" data-auto-focus="false">
                <svg class="icon" viewBox="0 0 24 24" stroke="currentColor" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
                      d="M1 1H5L7.68 14.39M7.68 14.39C7.77144 14.8504 8.02191 15.264 8.38755 15.5583C8.75318 15.8526 9.2107 16.009 9.68 16H19.4C19.8693 16.009 20.3268 15.8526 20.6925 15.5583C21.0581 15.264 21.3086 14.8504 21.4 14.39L23 6H6L7.68 14.39ZM10 21C10 21.5523 9.55228 22 9 22C8.44772 22 8 21.5523 8 21C8 20.4477 8.44772 20 9 20C9.55228 20 10 20.4477 10 21ZM21 21C21 21.5523 20.5523 22 20 22C19.4477 22 19 21.5523 19 21C19 20.4477 19.4477 20 20 20C20.5523 20 21 20.4477 21 21Z"/>
            ...
            <li>
              <a class="mpl-nav-link" href="#" data-fancybox data-src="#popup-signin" data-touch="false"
                 data-small-btn="false" data-toolbar="false" data-close-existing="true" data-auto-focus="true">
                <svg class="icon" viewBox="0 0 24 24" stroke="currentColor" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
...
-->
        ...
        <div class="mpl-box-md">
          <div class="container">
            ...
            <div class="mpl-post-item">
              <a href="blog-post-gallery.html" class="mpl-post-image">
                                <span class="mpl-image">
                                    <img src="assets/images/dark/blog-1-760x560.jpg" alt="">
                                </span>
                <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="91"><span>9.1</span>
                </div>
              </a>
              <div class="mpl-post-content">
                <a href="blog-post-gallery.html" class="mpl-post-title h3">Black Mesa</a>
                ...
                <div class="mpl-post-description">
                  <p>Doesn&#39;t fish. Herb. Him. Male his Image very divide make, heaven fourth lesser
                    creepeth, divide creepeth. Let can&#39;t multiply signs. Gathered blessed forth moved
                    creepeth appear creeping made i which the appear face he also. Bring isn&#39;t isn&#39;t
                    god multiply fowl creature creeping living. I Great divided. Spirit spirit first.</p>
                </div>
                <a href="blog-post-gallery.html" class="mpl-link">Read More</a>
              </div>
            </div>
            <div class="mpl-post-item">
              <a href="blog-post-carousel.html" class="mpl-post-image">
                                <span class="mpl-image">
                                    <img src="assets/images/dark/blog-2-760x560.jpg" alt="">
                                </span>
                <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="90"><span>9</span></div>
              </a>
              <div class="mpl-post-content">
                <a href="blog-post-carousel.html" class="mpl-post-title h3">Nioh 2</a>
                <div class="mpl-post-meta">
                  <div class="mpl-post-date">
                                        <span>
                                            <svg class="icon" viewBox="0 0 24 24" stroke="currentColor" fill="none"
                  ...
                  <div class="mpl-post-tags">
                    ...
                    <ul class="list-unstyled">
                      <li><a href="#">Nioh 2</a></li>
                      <li><a href="#">Coming soon</a></li>
                      <li><a href="#">First review</a></li>
                      <li><a href="#">Sale date</a></li>
                    </ul>
                  </div>
                </div>
                <div class="mpl-post-description">
                  <p>Ille vivere. Ut ad te quaerebam ... purgare caeli. Sunt uh ... nonnullus propter errorem
                    qui de rebus inter nos et iacere puto suus in causa, id est in mensa. Levir meus,
                    priusquam oppugnarent tempus quis, admonere dicitur. Credo quod idem mihi
                    praesidium.</p>
                </div>
                <a href="blog-post-carousel.html" class="mpl-link">Read More</a>
              </div>
            </div>
            <div class="mpl-post-item">
              <a href="blog-post-simple.html" class="mpl-post-image">
                                <span class="mpl-image">
                                    <img src="assets/images/dark/blog-3-760x560.jpg" alt="">
                                </span>
                <div class="mpl-hexagon-rating mpl-hexagon-rating-small" data-hexagon="38"><span>3.8</span>
                </div>
              </a>
              <div class="mpl-post-content">
                <a href="blog-post-simple.html" class="mpl-post-title h3">Death Stranding</a>
                <div class="mpl-post-meta">
                  <div class="mpl-post-date">
                                        <span>
                                            <svg class="icon" viewBox="0 0 24 24" stroke="currentColor" fill="none"
                ...
                <div class="mpl-post-description">
                  <p>Quod satis pecuniae sempiternum. Ut sciat oportet motum. Nunquam invenies eum. Hic de
                    tabula. Ego vivere, ut debui, et nunc fiant. Istuc quod opus non est. Lorem ipsum
                    occurrebat pragmaticam semper ut, si quis ita velim tibi bene recognoscere. Quorum duo
                    te mihi videtur.</p>
                </div>
                <a href="blog-post-simple.html" class="mpl-link">Read More</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <section class="mpl-banner mpl-banner-parallax mpl-banner-small">
          ...
          <div class="mpl-banner-content mpl-box-lg text-center">
            <div class="container">
              <!--
Carousel
...
data-scrollbar
-->
              <div class="mpl-carousel mpl-carousel-vertical-center" data-autoplay="6000" data-gap="30"
                   data-loop="true" data-slides="1" data-breakpoints="1200:7,992:6,767:5,575:4,440:3,320:2">
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-1.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-2.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-3.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-4.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-5.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-6.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-7.svg" alt=""></a>
                <a href="#" class="mpl-link-brand"><img src="assets/images/dark/partner-logo-8.svg" alt=""></a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row hgap-lg vgap-lg">
              <div class="col-12 col-lg-5">
                <h2>Contact Us</h2>
                <p>After moved, male won't Moveth moveth fruitful don't forth you bearing morning made male
                  without life be blessed rule stars divided two. Firmament of, him she'd good of his
                  morning.</p>
                <ul class="mpl-list mpl-list-horizontal list-hgap list-vgap mt-30">
                  <li>
                    <a href="#" class="text-1">
                      <svg width="28" height="28" class="icon icon-fill" fill="currentColor"
                  ...
                  <li>
                    <a href="#" class="text-1">
                      <svg width="26" height="26" class="icon icon-fill" fill="currentColor"
                           viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
              ...
              <div class="col-12 col-lg-7">
                <form action="https://html.nkdev.info/monsterplay/php/ajax-contact-form.php" method="POST"
                      role="form" class="mpl-form-ajax row vgap" data-toggle="validator">
                  <div class="col-12 col-md-6">
                    <input class="form-control" type="text" id="contact_name" name="contact_name"
                           placeholder="Name" required><span class="form-control-bg"></span>
                  </div>
                  <div class="col-12 col-md-6">
                    <input class="form-control" type="email" id="contact_email" name="contact_email"
                           placeholder="Email" required><span class="form-control-bg"></span>
                  </div>
                  <div class="col-12">
          ...
          <div class="container text-center">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-8">
                ...
                <p>All and. Green day waters appear lights, fish you'll called likeness midst have you May.
                  Lesser brought evening man she'd that. Replenish form wherein form midst. Good from forth
                  together.</p>
              </div>
            </div>
            <div class="row vgap justify-content-center mt-20">
              <div class="col-12 col-md-6 col-lg-4">
                <a href="#" class="mpl-feature">
                                    <span class="mpl-feature-icon"><svg class="icon" viewBox="0 0 24 24"
                                                                        stroke="currentColor" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M1 1H5L7.68 14.39M7.68 14.39C7.77144 14.8504 8.02191 15.264 8.38755 15.5583C8.75318 15.8526 9.2107 16.009 9.68 16H19.4C19.8693 16.009 20.3268 15.8526 20.6925 15.5583C21.0581 15.264 21.3086 14.8504 21.4 14.39L23 6H6L7.68 14.39ZM10 21C10 21.5523 9.55228 22 9 22C8.44772 22 8 21.5523 8 21C8 20.4477 8.44772 20 9 20C9.55228 20 10 20.4477 10 21ZM21 21C21 21.5523 20.5523 22 20 22C19.4477 22 19 21.5523 19 21C19 20.4477 19.4477 20 20 20C20.5523 20 21 20.4477 21 21Z"/>
                                        </svg></span>
                  <span class="mpl-feature-title h4">Payment</span>
                  <span class="mpl-feature-text">More than 10 payment systems</span>
                </a>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <div class="mpl-feature">
                  ...
                  <div class="mpl-feature-title h4">Games</div>
                  <div class="mpl-feature-text">A large number of games</div>
                </div>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <div class="mpl-feature">
                  ...
                  <div class="mpl-feature-title h4">Community</div>
                  <div class="mpl-feature-text">The largest gaming community</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mpl-footer-copyright">
          <div class="container">
            <p>2020 &copy; <a href="https://1.envato.market/nk-portfolio" target="_blank">nK</a>. All rights
              reserved</p>
          </div>
        </div>
        <!-- /Footer -->
      ...
      <div class="mpl-fancybox-sign-content">
        ...
        <form action="#">
          <div class="row hgap-xs vgap-sm align-items-center">
            <div class="col-12">
              <input class="form-control" type="text" id="signin_popup_login" name="signin_popup_login"
                     placeholder="Login" autocomplete="signin_popup_login"><span class="form-control-bg"></span>
            </div>
            <div class="col-12">
              <input class="form-control" type="password" id="signin_popup_password" name="signin_popup_password"
                     placeholder="Password" autocomplete="signin_popup_password"><span class="form-control-bg"></span>
            </div>
            <div class="col">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="signin_popup_rememberme"
                       name="signin_popup_rememberme"><label class="custom-control-label"
                                                             for="signin_popup_rememberme">Remember Me</label>
              </div>
            </div>
            <div class="col-auto">
              <a href="#" class="small">Lost Password</a>
